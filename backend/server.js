...
// ✅ Dynamic CORS setup using allowed origins
...
app.post("/api/signup", async (req, res) => {
  ...
  try {
    ...
    const token = jwt.sign({ userId: newUser._id }, process.env.JWT_SECRET || 'defaultsecret', { expiresIn: '7d' });
...
// 🌍 Default route
app.get("/", (req, res) => res.send("🚀 BusSeva Backend is running..."));
